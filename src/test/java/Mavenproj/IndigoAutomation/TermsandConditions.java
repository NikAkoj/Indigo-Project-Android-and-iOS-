...
public class TermsandConditions extends ListernersIndigoAndroid{
	
	
	@Test(priority = 1)
	public void Termsandconditionview() throws MalformedURLException, InterruptedException
	{
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//android.widget.TextView[@text='Terms & Conditions']")));
		WebElement terms = driver.findElement(By.xpath("//android.widget.TextView[@text='Terms & Conditions']"));
		terms.click();
