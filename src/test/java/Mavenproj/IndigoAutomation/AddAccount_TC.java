...
public class AddAccount_TC extends ListernersIndigoAndroid{
	...
	public void Trytoaddwithoutpassword() throws MalformedURLException
	{
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.id("com.shireburn.indigo:id/btnAcceptTerms")));
		WebElement btnallow = driver.findElement(By.id("com.shireburn.indigo:id/btnAcceptTerms"));
		btnallow.click();
		...
		seconduser.sendKeys("mis@narola.email");
 	...
 	public void Addaccount() throws MalformedURLException
	{
		AndroidDriver<AndroidElement> driver = capabilities();
				...
				new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.Button[@text='AGREE']")));
				WebElement btnagree1 = driver.findElement(By.xpath("//android.widget.Button[@text='AGREE']"));
				btnagree1.click();
				...
				new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.TextView[@text='mis@narola.email']")));
				...
				new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.id("com.shireburn.indigo:id/cvUserImage")));
				WebElement profile1 = driver.findElement(By.id("com.shireburn.indigo:id/cvUserImage"));
				profile1.click();
