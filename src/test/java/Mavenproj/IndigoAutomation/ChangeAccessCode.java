...
public class ChangeAccessCode extends ListernersIndigoAndroid{
	...
	public void Trytogetwithvalidusername() throws MalformedURLException
	{
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.id("com.shireburn.indigo:id/txtAccessCode")));
		WebElement accesscode = driver.findElement(By.id("com.shireburn.indigo:id/txtAccessCode"));
		accesscode.click();
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.TextView[@text='Get Code']")));
		WebElement getrecovercode = driver.findElement(By.xpath("//android.widget.TextView[@text='Get Code']"));
		getrecovercode.click();
		
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.id("com.shireburn.indigo:id/txtRecoverPasswordSentMsg")));
		driver.findElement(By.id("com.shireburn.indigo:id/txtRecoverPasswordSentMsg"));
