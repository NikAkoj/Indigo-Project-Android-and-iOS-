...
public class Termsandconditions extends ListernersIndigoiOS{
	
	
	@Test
	public void Viewterms() throws MalformedURLException, InterruptedException
	{
		...
		WebElement terms = driver.findElement(By.xpath("//XCUIElementTypeStaticText[@name=\"Terms & Conditions\"]"));
		terms.click();
