...
public class ChangePasswordiOS extends ListernersIndigoiOS{
	
	@Test(priority=1)
	public void RecoverPassword() throws InterruptedException, MalformedURLException
	{
		...
		WebElement recpassword = driver.findElement(By.xpath("//XCUIElementTypeStaticText[@name=\"Change or Recover your Password\"]"));
		recpassword.click();
		...
		WebElement getpsw = driver.findElement(By.xpath("//XCUIElementTypeStaticText[@name=\"Get Password Reset\"]"));
		getpsw.click();
