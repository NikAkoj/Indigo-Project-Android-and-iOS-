...
public class ProvideFeedbackiOS extends ListernersIndigoiOS{
	
	
	@Test
	public void Viewfeedback() throws MalformedURLException, InterruptedException
	{
		...
		WebElement feedback = driver.findElement(By.xpath("//XCUIElementTypeStaticText[@name=\"Provide Feedback\"]"));
		feedback.click();
